<template>
  <div class="player-wrapper"  @mouseup="upFn"  @mousemove="moveFn">
    ...
    <div class="mini-player">
      ...
      <!-- 播放音乐的API接口 -->
      <!-- http://dl.stream.qqmusic.qq.com/C400${musicData.songmid}.m4a?vkey=${songVkey}&guid=2156461708&uni=0&fromtag=66 -->
      <!--http://dl.stream.qqmusic.qq.com/C400${musicData.songmid}/${musicData.songid}.m4a?guid=263427534&fromtag=66 -->
      <audio ref="audio" v-if="currentSong.songid" :src="`http://dl.stream.qqmusic.qq.com/C400${currentSong.songmid}/${currentSong.songid}.m4a?guid=2156461708&uni=0&fromtag=66`"
